...
function TeacherImage() {
  return (
    <div className="overflow-hidden rounded-[1.5rem] bg-[#eef4ff]">
      <img src={teacherImage} alt="ප්‍රසාද් සර්" className="h-[340px] w-full object-cover object-top md:h-[460px]" />
    </div>
  );
}
    ...
    <main className="min-h-screen bg-[#f6f9ff] text-[#071a3d]">
      <nav className="sticky top-0 z-50 border-b border-white/20 bg-[#071a3d]/95 text-white backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
          <a href="#top" className="flex min-w-0 items-center gap-3">
            <img src={logoImage} alt="ප්‍රසාද් සර්ගේ ශිෂ්‍යත්ව පන්තිය" className="h-12 w-12 shrink-0 rounded-2xl bg-white object-cover ring-1 ring-white/20" />
            <div className="min-w-0">
              <p className="truncate text-sm font-black sm:text-lg">ප්‍රසාද් සර්ගේ ශිෂ්‍යත්ව පන්තිය</p>
              <p className="text-[10px] font-bold tracking-[0.22em] text-[#f0cf79] sm:text-xs">03 | 04 | 05 ශ්‍රේණි</p>
            </div>
          </a>
          ...
          <a href={whatsappLink} className="shrink-0 rounded-full bg-[#d4af37] px-4 py-3 text-xs font-black text-[#071a3d] transition hover:bg-[#f0cf79] sm:px-5 sm:text-sm">WhatsApp</a>
        </div>
      </nav>

      <section id="top" className="relative overflow-hidden bg-gradient-to-br from-[#071a3d] via-[#0f2c60] to-[#134885] px-5 py-16 text-white md:py-28">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 md:grid-cols-[1.05fr_0.95fr]">
          <div>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              <div className="rounded-3xl bg-white/10 p-5 backdrop-blur"><p className="text-sm text-white/60">ශ්‍රේණි</p><p className="mt-2 text-3xl font-black text-[#f0cf79]">03 - 05</p></div>
              <div className="rounded-3xl bg-white/10 p-5 backdrop-blur"><p className="text-sm text-white/60">මාසික ගාස්තුව</p><p className="mt-2 text-3xl font-black text-[#f0cf79]">1000</p></div>
              <div className="rounded-3xl bg-white/10 p-5 backdrop-blur"><p className="text-sm text-white/60">WhatsApp</p><p className="mt-2 text-2xl font-black text-[#f0cf79]">0774104483</p></div>
            </div>
          </div>
            ...
            <div className="rounded-[2rem] border border-white/20 bg-white/10 p-4 backdrop-blur-xl">
              <div className="rounded-[1.5rem] bg-white p-6 text-[#071a3d] shadow-2xl">
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-3 leading-7 text-slate-600">ශිෂ්‍යත්ව විභාගයට දරුවන් ක්‍රමවත් ලෙස සූදානම් කරන, දෙමාපියන්ට විශ්වාසයක් ලබාදෙන ඉගැන්වීමේ පද්ධතියක්.</p>
                </div>
                <div className="mt-6 rounded-3xl bg-[#071a3d] p-6 text-white">
                  ...
                  <p className="mt-3 text-lg font-bold leading-8">තම පාසල් පන්තියේ ළමුන් 55 න් 45 ක්ම සමත් කරවූ, ප්‍රායෝගික අත්දැකීම් සහිත ශිෂ්‍යත්ව ගුරුවරයෙකුගේ මඟපෙන්වීම.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="about" className="px-5 py-20">
        <div className="mx-auto max-w-7xl">
          <SectionHeading eyebrow="විශේෂත්වය" title="අපේ පන්තිය තෝරාගත යුත්තේ ඇයි?" text="ශිෂ්‍යත්වයට දරුවා සූදානම් කිරීම කියන්නේ වැඩිපුර ප්‍රශ්න කරවීම පමණක් නොවෙයි. දරුවාගේ සිතීම, අවධානය, කියවීම, ලිවීම, කාල කළමනාකරණය සහ ප්‍රශ්න විසඳීමේ විශ්වාසය එකම මාර්ගයකට ගෙන ඒමයි." />
      ...
      <section id="classes" className="bg-white px-5 py-20">
        <div className="mx-auto max-w-7xl">
          <SectionHeading eyebrow="පන්ති කාලසටහන" title="ශ්‍රේණි අනුව පන්ති විස්තර" text="දරුවාගේ ශ්‍රේණිය අනුව පාඩම් පැහැදිලි කිරීම, ගැටලු විසඳීම සහ ප්‍රශ්න පත්‍ර පුහුණුව වෙන් කර ඇත." />
          <div className="grid gap-6 lg:grid-cols-3">
            {classData.map((item) => (
              <Card key={item.grade} className="relative overflow-hidden">
                ...
                <div className="mt-6 space-y-3">{item.schedule.map((line) => <p key={line} className="rounded-2xl bg-[#f2f7ff] px-4 py-3 font-bold text-[#071a3d]">{line}</p>)}</div>
                <p className="mt-6 leading-7 text-slate-600">{item.focus}</p>
                <div className="mt-6 rounded-2xl bg-gradient-to-r from-[#071a3d] to-[#134885] px-5 py-4 text-white"><p className="text-sm text-white/70">මාසික ගාස්තුව</p><p className="text-2xl font-black text-[#f0cf79]">{item.fee}</p></div>
              </Card>
            ))}
          </div>
        </div>
      ...
      <section id="fees" className="px-5 py-20">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <Card className="border-[#f1df9a] bg-[#fff7df]">
            <p className="mb-3 text-sm font-black tracking-[0.25em] text-[#9d7412]">පන්ති ගාස්තුව</p><h2 className="text-4xl font-black text-[#071a3d]">මාසික ගාස්තු</h2>
            <div className="mt-8 space-y-4"><div className="rounded-3xl bg-white p-6 shadow-sm"><p className="text-slate-500">3 - 4 ශ්‍රේණි</p><p className="mt-2 text-4xl font-black text-[#071a3d]">රු. 1000/=</p></div><div className="rounded-3xl bg-white p-6 shadow-sm"><p className="text-slate-500">5 ශ්‍රේණිය</p><p className="mt-2 text-4xl font-black text-[#071a3d]">රු. 1000/=</p></div></div>
            <p className="mt-6 leading-7 text-slate-700">මාසයට අදාළ පන්ති ගාස්තු ගෙවීමෙන් පසු පන්තියට සම්බන්ධ කරගනු ලැබේ.</p>
          </Card>
          <Card id="payment">
            <p className="mb-3 text-sm font-black tracking-[0.25em] text-[#bd8d19]">සම්බන්ධ වන ආකාරය</p><h2 className="text-3xl font-black">පන්තියට සම්බන්ධ වන පියවර</h2>
            <div className="mt-6 space-y-4"><div className="rounded-2xl bg-[#f2f7ff] p-5"><p className="font-bold leading-7 text-[#071a3d]">1. පහත බැංකු ගිණුමකට පන්ති ගාස්තුව ගෙවන්න.</p></div><div className="rounded-2xl bg-[#f2f7ff] p-5"><p className="font-bold leading-7 text-[#071a3d]">2. ගෙවීමෙන් පසු slip / receipt එක WhatsApp කරන්න.</p></div><div className="rounded-2xl bg-[#f2f7ff] p-5"><p className="font-bold leading-7 text-[#071a3d]">3. දරුවාගේ නම, ශ්‍රේණිය සහ දරුවාට ඇති අධ්‍යාපනික අඩුපාඩු සඳහන් කරන්න.</p></div><div className="rounded-2xl bg-[#f2f7ff] p-5"><p className="font-bold leading-7 text-[#071a3d]">4. කියවීම, ලිවීම, අවධානය, අමතකවීම හෝ ගැටලු විසඳීමේ අපහසුතා ඇත්නම් පැහැදිලිව දන්වන්න.</p></div></div>
            <a href={whatsappLink} className="mt-8 block rounded-3xl bg-[#071a3d] p-6 text-white transition hover:bg-[#134885]"><p className="text-sm font-bold tracking-[0.2em] text-[#f0cf79]">WhatsApp හරහා slip එක එවන්න</p><p className="mt-3 text-3xl font-black">0774104483</p></a>
          </Card>
        </div>
      </section>
      ...
      <section className="bg-white px-5 py-20">
        <div className="mx-auto max-w-7xl">
          <SectionHeading eyebrow="බැංකු විස්තර" title="ගෙවීම් සඳහා ගිණුම් අංක" text="පහත ගිණුම්වලින් ඕනෑම එකකට ගාස්තුව ගෙවා slip එක WhatsApp කරන්න." />
          <div className="grid gap-6 md:grid-cols-3">{banks.map((bank) => <Card key={bank.bank} className="bg-[#f8fbff]"><p className="text-2xl font-black text-[#071a3d]">{bank.bank}</p><p className="mt-4 text-sm leading-6 text-slate-600">{bank.name}</p><div className="mt-4 rounded-2xl bg-white px-4 py-3 text-lg font-black text-[#071a3d] shadow-sm">{bank.account}</div>{bank.branch && <p className="mt-3 text-sm text-slate-500">{bank.branch}</p>}</Card>)}</div>
        </div>
      </section>

      <section id="reviews" className="bg-[#eef4ff] px-5 py-20">
        <div className="mx-auto max-w-7xl">
          <SectionHeading eyebrow="දෙමාපිය අදහස්" title="රටේ විවිධ ප්‍රදේශවල දෙමාපියන්ගේ අදහස්" text="මෙම අදහස් sample ලෙස දමා ඇත. පසුව සැබෑ reviews ලැබුණු විට ඒවාට replace කළ හැක." />
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">{reviews.map((review) => <Card key={review.name}><p className="text-4xl text-[#bd8d19]">“</p><p className="leading-7 text-slate-600">{review.text}</p><div className="mt-6 border-t border-[#d9e2f2] pt-5"><p className="font-black">{review.name}</p><p className="text-sm text-slate-500">මව | {review.area}</p></div></Card>)}</div>
        </div>
      </section>
      ...
      <section className="px-5 py-20">
        <div className="mx-auto max-w-7xl rounded-[2.5rem] bg-gradient-to-br from-[#071a3d] to-[#134885] p-8 text-center text-white md:p-14">
          <p className="mb-4 text-sm font-black tracking-[0.25em] text-[#f0cf79]">පන්තියට සම්බන්ධ වීම</p><h2 className="text-3xl font-black md:text-5xl">දරුවාට ගැළපෙන පන්තිය තෝරාගෙන අදම සම්බන්ධ වන්න</h2><p className="mx-auto mt-5 max-w-3xl leading-8 text-white/75">පන්ති ගාස්තුව ගෙවා slip එක, දරුවාගේ නම, ශ්‍රේණිය සහ ඇති අඩුපාඩු WhatsApp හරහා එවන්න. එවිට පන්තියට සම්බන්ධ කිරීමේ ඉදිරි ක්‍රියාවලිය ඉක්මනින් සිදු කළ හැක.</p><a href={whatsappLink} className="mt-8 inline-flex rounded-full bg-[#d4af37] px-9 py-4 font-black text-[#071a3d] transition hover:bg-[#f0cf79]">0774104483 වෙත WhatsApp කරන්න</a>
        </div>
      </section>

      <footer className="border-t border-[#d9e2f2] bg-white px-5 py-10">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 text-center md:flex-row md:items-center md:justify-between md:text-left"><div><p className="text-xl font-black text-[#071a3d]">ප්‍රසාද් සර්ගේ ශිෂ්‍යත්ව පන්තිය</p><p className="text-sm text-slate-500">03, 04, 05 ශ්‍රේණි | මාර්ගගත ශිෂ්‍යත්ව පන්තිය</p></div><p className="text-sm text-slate-500">© Prasad Sir Scholarship Class. All rights reserved.</p></div>
      </footer>
    </main>
  );
}
